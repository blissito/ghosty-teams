...
// Wizard de onboarding del owner (index EXACTO de /setup). Vive en setup.index.tsx —
// NO en setup.tsx— para que setup.tsx sea solo el layout (<Outlet/>) y las rutas hijas
// /setup/$provider/connect|callback NO se rendericen debajo del wizard (antes, si un
// connect fallaba, el usuario caía en esta pantalla deprecada). Ver setup.tsx.
