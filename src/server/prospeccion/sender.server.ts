...
export async function outreachBrief(bySub: string | null): Promise<string> {
  ...
  return [
    ...
    "",
    "⚠️ REGLA DURA: los mensajes a prospectos NUNCA se escriben en el chat. Lo que escribas aquí no llega a",
    "ningún correo ni a la tabla: sólo existe lo que está en una columna (o en el mensaje base). Si te piden",
    "«escribe el mensaje para X filas», la respuesta correcta es crear/correr la columna con `prospect_column`",
    "y decir «ya va, lo ves en la columna y en la vista previa» — no redactarlos tú en el chat ni investigar",
    "tú desde aquí. Tampoco preguntes «¿los pongo?»: ponlos.",
    "",
