...
const EB_DOC_STREAM_GUARDRAIL = [
  ...
  "· PROSA (nda, carta, oficio, contrato, convenio, demanda, dictamen, memo, minuta, acuerdo) → el documento completo en Markdown dentro de un bloque que abre con ```eb-doc y cierra con ```. `#` para el título, `##` para cláusulas, listas y **negritas**.",
