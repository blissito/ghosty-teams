...
export const en: Record<string, string> = {
  ...
  "Trabajar con el repositorio": "Work with the repository",
  "Además, GitHub: leer código, abrir issues y pull requests. En un room sólo toca los repos conectados ahí.": "Plus GitHub: read code, open issues and pull requests. In a room it only touches the repos connected there.",
